...
const WhyChoseUs = () => {
    ...
    return (
      ...
      }} className=" p-6 bg-gray-50 drop-shadow-md shadow h-[650px]">
  <div className="max-w-7xl mx-auto flex mt-10 gap-20">
  <div>
   ...
   <img className="w-full -mt-32 -z-20"  src="/src/assets/image-removebg-preview (3).png" alt="" />
   </div>

   <div className="flex flex-col gap-5">


    <div className="w-[450px] bg-white p-4 py-2 rounded-2xl shadow ">
    ...
    <div className="w-[500px] bg-white p-4 py-2 rounded-2xl shadow ml-10">
        <div className="flex items-start gap-5 mt-2">
    ...
    <div className="w-[500px] bg-white p-4 py-2 rounded-2xl shadow ">
        <div className="flex items-start gap-5 mt-2">
