...
const BookingFrom = () => {
    return (
        <div data-aos="fade-up" data-aos-duration="2000" className="bg-white shadow lg:max-w-4xl md:max-w-2xl mx-auto px-5 py-5 lg:-mt-32 md:-mt-10 z-90 opacity-90 rounded-2xl ">
          ...
          <button className="flex items-center hover:gap-2 bg-yellow-400 text-black rounded-2xl px-4 justify-center w-full md:w-[80%] h-14 mt-3 font-bold drop-shadow-md text-xl cursor-pointer ">
