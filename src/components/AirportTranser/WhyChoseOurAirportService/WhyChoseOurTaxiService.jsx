        ...
        <div className="max-w-6xl mx-auto py-5">
         ...
         <p className="text-2xl mt-5"><span className="font-bold">1.</span> Punctual and Reliable Pickups</p>
            <ul className="mt-1">
                ...
                <li className="flex justify-start items-center gap-1 "> <span><FcApproval/></span> Flight monitoring to adjust pickup times for any delays.</li>
         ...
         <p className="text-2xl mt-5"><span className="font-bold">2.</span> Wide Coverage Across London</p>
            <ul className="mt-1">
                ...
                <li className="flex justify-start items-center gap-1 "> <span><FcApproval/></span>Door-to-door service for both residential and commercial clients.</li>
         ...
         <p className="text-2xl mt-5"><span className="font-bold">3.</span>Comfortable and Modern Fleet</p>
            <ul className="mt-1">
                ...
                <li className="flex justify-start items-center gap-1 "> <span><FcApproval/></span>Options for solo travelers and groups with luggage.</li>
         ...
         <p className="text-2xl mt-5"><span className="font-bold">4.</span>Professional Drivers</p>
            <ul className="mt-1">
                ...
                <li className="flex justify-start items-center gap-1 "> <span><FcApproval/></span>Expert knowledge of London's routes and traffic patterns.</li>
         ...
         <p className="text-2xl mt-5"><span className="font-bold">5.</span>Safe and Secure Travel</p>
            <ul className="mt-1">
                ...
                <li className="flex justify-start items-center gap-1 "> <span><FcApproval/></span>Adherence to high safety and hygiene standards.</li>
         ...
         <p className="text-2xl mt-5"><span className="font-bold">6.</span>Competitive Pricing</p>
            <ul className="mt-1">
                ...
                <li className="flex justify-start items-center gap-1 "> <span><FcApproval/></span>Cost-effective options for solo and group travel.</li>
         ...
         <p className="text-2xl mt-5"><span className="font-bold">7.</span>Simple Booking Process</p>
            <ul className="mt-1">
                ...
                <li className="flex justify-start items-center gap-1 "> <span><FcApproval/></span>24/7 customer support to assist with bookings or inquiries.</li>
         ...
         <div>
            ...
            <ul className="mt-1">
                ...
                <li className="flex justify-start items-center gap-1 "> <span><FcApproval/></span>Assistance with luggage handling.</li>
                <li className="flex justify-start items-center gap-1 "> <span><FcApproval/></span>Child car seats available upon request.</li>
...
export default WhyChoseOurTaxiService;